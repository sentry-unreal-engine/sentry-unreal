...
- Bump Java SDK (Android) from v8.17.0 to v8.36.0 ([#97](https://github.com/sentry-unreal-engine/sentry-unreal/pull/97))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8360)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.17.0...8.36.0)
