...
- Bump Java SDK (Android) from v8.17.0 to v8.43.2 ([#145](https://github.com/sentry-unreal-engine/sentry-unreal/pull/145))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8432)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.17.0...8.43.2)
