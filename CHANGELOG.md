...
- Bump Java SDK (Android) from v8.17.0 to v8.34.0 ([#89](https://github.com/sentry-unreal-engine/sentry-unreal/pull/89))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8340)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.17.0...8.34.0)
