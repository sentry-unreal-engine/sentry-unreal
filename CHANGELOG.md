...
- Bump Java SDK (Android) from v8.17.0 to v8.35.0 ([#96](https://github.com/sentry-unreal-engine/sentry-unreal/pull/96))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8350)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.17.0...8.35.0)
