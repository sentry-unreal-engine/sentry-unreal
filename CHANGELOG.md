...
- Bump Java SDK (Android) from v8.17.0 to v8.51.0 ([#180](https://github.com/sentry-unreal-engine/sentry-unreal/pull/180))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8510)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.17.0...8.51.0)
