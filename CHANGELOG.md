...
- Bump Java SDK (Android) from v8.17.0 to v8.22.0 ([#24](https://github.com/sentry-unreal-engine/sentry-unreal/pull/24))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8220)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.17.0...8.22.0)
