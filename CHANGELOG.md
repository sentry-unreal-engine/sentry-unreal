...
- Bump Java SDK (Android) from v8.17.0 to v8.40.0 ([#117](https://github.com/sentry-unreal-engine/sentry-unreal/pull/117))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8400)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.17.0...8.40.0)
