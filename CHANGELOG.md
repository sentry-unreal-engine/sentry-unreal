...
- Bump Java SDK (Android) from v8.17.0 to v8.52.0 ([#184](https://github.com/sentry-unreal-engine/sentry-unreal/pull/184))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8520)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.17.0...8.52.0)
