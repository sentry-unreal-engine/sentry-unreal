...
- Bump Java SDK (Android) from v8.17.0 to v8.41.0 ([#126](https://github.com/sentry-unreal-engine/sentry-unreal/pull/126))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8410)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.17.0...8.41.0)
