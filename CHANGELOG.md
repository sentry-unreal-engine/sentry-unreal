...
- Bump Java SDK (Android) from v8.17.0 to v8.34.1 ([#91](https://github.com/sentry-unreal-engine/sentry-unreal/pull/91))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8341)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.17.0...8.34.1)
