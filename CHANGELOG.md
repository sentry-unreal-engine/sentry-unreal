...
- Bump Java SDK (Android) from v8.17.0 to v8.27.0 ([#50](https://github.com/sentry-unreal-engine/sentry-unreal/pull/50))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8270)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.17.0...8.27.0)
