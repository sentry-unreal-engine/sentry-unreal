...
- Bump Java SDK (Android) from v8.17.0 to v8.33.0 ([#79](https://github.com/sentry-unreal-engine/sentry-unreal/pull/79))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8330)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.17.0...8.33.0)
