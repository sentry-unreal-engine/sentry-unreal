...
- Bump Java SDK (Android) from v8.17.0 to v8.23.0 ([#31](https://github.com/sentry-unreal-engine/sentry-unreal/pull/31))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8230)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.17.0...8.23.0)
