...
- Bump Java SDK (Android) from v8.17.0 to v8.30.0 ([#65](https://github.com/sentry-unreal-engine/sentry-unreal/pull/65))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8300)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.17.0...8.30.0)
