...
- Bump Java SDK (Android) from v8.17.0 to v8.32.0 ([#74](https://github.com/sentry-unreal-engine/sentry-unreal/pull/74))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8320)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.17.0...8.32.0)
