...
- Bump Java SDK (Android) from v8.17.0 to v8.27.1 ([#51](https://github.com/sentry-unreal-engine/sentry-unreal/pull/51))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8271)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.17.0...8.27.1)
