...
- Bump Java SDK (Android) from v8.17.0 to v8.29.0 ([#59](https://github.com/sentry-unreal-engine/sentry-unreal/pull/59))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8290)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.17.0...8.29.0)
