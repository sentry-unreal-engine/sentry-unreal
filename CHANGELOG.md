...
- Bump Java SDK (Android) from v8.17.0 to v8.50.1 ([#177](https://github.com/sentry-unreal-engine/sentry-unreal/pull/177))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8501)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.17.0...8.50.1)
