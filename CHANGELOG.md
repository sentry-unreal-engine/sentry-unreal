...
- Bump Java SDK (Android) from v8.17.0 to v8.26.0 ([#48](https://github.com/sentry-unreal-engine/sentry-unreal/pull/48))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8260)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.17.0...8.26.0)
