...
- Bump Java SDK (Android) from v8.17.0 to v8.24.0 ([#37](https://github.com/sentry-unreal-engine/sentry-unreal/pull/37))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8240)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.17.0...8.24.0)
