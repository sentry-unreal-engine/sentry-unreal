...
- Bump Java SDK (Android) from v8.17.0 to v8.43.0 ([#137](https://github.com/sentry-unreal-engine/sentry-unreal/pull/137))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8430)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.17.0...8.43.0)
