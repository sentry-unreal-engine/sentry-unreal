...
- Bump Java SDK (Android) from v8.17.0 to v8.53.0 ([#188](https://github.com/sentry-unreal-engine/sentry-unreal/pull/188))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8530)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.17.0...8.53.0)
