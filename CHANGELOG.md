...
- Bump Java SDK (Android) from v8.17.0 to v8.46.0 ([#159](https://github.com/sentry-unreal-engine/sentry-unreal/pull/159))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8460)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.17.0...8.46.0)
