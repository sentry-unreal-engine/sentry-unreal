...
- Bump Java SDK (Android) from v8.17.0 to v8.50.0 ([#175](https://github.com/sentry-unreal-engine/sentry-unreal/pull/175))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8500)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.17.0...8.50.0)
