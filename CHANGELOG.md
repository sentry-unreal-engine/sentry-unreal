...
- Bump Java SDK (Android) from v8.17.0 to v8.55.0 ([#197](https://github.com/sentry-unreal-engine/sentry-unreal/pull/197))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8550)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.17.0...8.55.0)
