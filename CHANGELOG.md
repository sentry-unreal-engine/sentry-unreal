...
- Bump Java SDK (Android) from v8.17.0 to v8.45.0 ([#157](https://github.com/sentry-unreal-engine/sentry-unreal/pull/157))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8450)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.17.0...8.45.0)
